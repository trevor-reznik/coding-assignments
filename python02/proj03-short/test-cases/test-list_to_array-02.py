...
nodes   = [ list_node.ListNode("one"),
            list_node.ListNode("two"),
            list_node.ListNode("three"),
            list_node.ListNode("four"),
            list_node.ListNode("open"),
            list_node.ListNode("the"),
            list_node.ListNode("door") ]
